$(function () {
    ...
    $(".btnRun").click(function () {
        ...
        $.ajax({
            url: "/job/api/runOneJob?t=" + new Date().getTime(),
            type: "POST",
            data: {
    ...
    $(".btnPause").click(function () {
        var jobId = $(this).parent().data("id");
        $.ajax({
            url: "/job/api/pauseJob?t=" + new Date().getTime(),
            type: "POST",
            data: {
                "jobName": $("#name_" + jobId).text(),
                "jobGroup": $("#group_" + jobId).text()
    ...
    $(".btnResume").click(function () {
        var jobId = $(this).parent().data("id");
        $.ajax({
            url: "/job/api/resumeJob?t=" + new Date().getTime(),
            type: "POST",
            data: {
                "jobName": $("#name_" + jobId).text(),
                "jobGroup": $("#group_" + jobId).text()
    ...
    $(".btnDelete").click(function () {
        var jobId = $(this).parent().data("id");
        $.ajax({
            url: "/job/api/deleteJob?t=" + new Date().getTime(),
            type: "POST",
            data: {
                "jobName": $("#name_" + jobId).text(),
                "jobGroup": $("#group_" + jobId).text()
    ...
    $("#save").click(
        function () {
            ...
            $.ajax({
                url: "/job/api/saveOrUpdate?t=" + new Date().getTime(),
                type: "POST",
